...
angular.module('ngCart', ['ngCart.directives'])
    ...
    .service('ngCart', [
        '$rootScope', 'ngCartItem', 'store', 'ngCart.lottoyard.api', 'Products', function ($rootScope, ngCartItem, store, LottoYardService, Products) {
            ...
            this.addItem = function (id, discount, groupComboBoxSelectionIndex, groupSettingsIndex, groupdiscount, groupnodraws, groupnoshares, grouporiginalprice,
                grouptotal, lotteryType, noofdraws, nooflines, numbers, originalprice, personalComboBoxSelectionIndex, personalSettingsIndex, selectedTab, totalCost, isSubscription, isQuickPick, ticketsNumbers, productType, productExpire, quantity) {
                //debugger;
                ...
                if (typeof inCart === 'object') {
                    ...
                    if (productType === 2 || productType === 4 || productType === 14 || productType === 19) {
                        ...
                        var newItem = new ngCartItem(id, discount, groupComboBoxSelectionIndex, groupSettingsIndex, groupdiscount, groupnodraws, groupnoshares, grouporiginalprice,
                            ...
                            rules.SelectNumbers, rules.MinSelectNumber, rules.MaxSelectNumbers, rules.ExtraNumbers, rules.MaxExtraNumbers, rules.MinExtraNumber, productRules.MinLines, productRules.MaxLines, rules.DrawsPerWeek, product.Draws, isFastProcessing, isSubscription, isQuickPick, ticketsNumbers, productType, productExpire, quantity);
                        ...
                        if (productType === 15 || productType === 24 || productType === 26) {
                            rules.MinLines = 1;
                        ...
                        var newItem = new ngCartItem(id, discount, groupComboBoxSelectionIndex, groupSettingsIndex, groupdiscount, groupnodraws, groupnoshares, grouporiginalprice,
                            ...
                            rules.SelectNumbers, rules.MinSelectNumber, rules.MaxSelectNumbers, rules.ExtraNumbers, rules.MaxExtraNumbers, rules.MinExtraNumber, rules.MinLines, rules.MaxLines, rules.DrawsPerWeek, rules.ProductsDrawOptions, isFastProcessing, isSubscription, isQuickPick, ticketsNumbers, productType, productExpire, quantity);
                    }
    ...
    .factory('ngCartItem', [
        '$rootScope', '$log', '$timeout', function ($rootScope, $log) {
            ...
            var item = function (id, discount, groupComboBoxSelectionIndex, groupSettingsIndex, groupdiscount, groupnodraws, groupnoshares, grouporiginalprice,
                grouptotal, lotteryType, noofdraws, nooflines, numbers, originalprice, personalComboBoxSelectionIndex, personalSettingsIndex, selectedTab, totalCost, lotteryname,
                selectNumbers, minSelectNumber, maxSelectNumbers, extraNumbers, maxExtraNumbers, minExtraNumber, minLines, maxLines, drawsPerWeek, productsDrawOptions, isFastProcessing, isSubscription, isQuickPick, ticketsNumbers, productType, productExpire, quantity) {
    ...
    .service('store', [
        '$window', 'CacheFactory', function ($window, CacheFactory) {
    ...
    .controller('CartController', [
        ...
        function ($scope, ngCart, ngDialog, $controller, $rootScope, LottoyardService, $location, PaymentSystems, GetCountryByIpService, translationService) {
            ...
            $scope.country_code = '';
            $scope.signup = { mobileNumber: "", fullname: "", email: "", password: "" };
            $scope.terms = false;
            ...
            $scope.creditCardExpirationYears = [$scope.currentYear, $scope.currentYear + 1, $scope.currentYear + 2, $scope.currentYear + 3, $scope.currentYear + 4, $scope.currentYear + 5];
            ...
            $scope.redirectToCart = function ($event) {
                ...
                window.location = '/' + $scope.language + '/cart/';
            }
            ...
            $scope.initSignUp = function () {
                ...
                GetCountryByIpService.getCountryCodeByIp().then(function (data) {
                    ...
                    $scope.country_code = CountryCodeNames.filter(function (v) { return v.code === data })[0];
                });
            };
            ...
            $scope.forgotpass = function ($event, user) {
                ...
                if (typeof (user) === 'undefined') {
                    $scope.signinError = true;
                    $scope.errorText = "'Email' address is not valid";
                    return;
                }
    ...
    .controller('DepositController', ['$rootScope', '$scope', 'ngCart', 'ngCart.lottoyard.api', 'ngCart.translationService', 'PaymentSystems', function ($rootScope, $scope, ngCart, LottoyardService, translationService, PaymentSystems) {
        $scope.ngCart = ngCart;
    ...
    .controller('someCtrl', function ($scope, item, line) {
        //debugger;
    ...
    service.getFreeTicket = function getFreeTicket() {
        ...
        if (dataCache.get(id)) {
            ...
            $http({
                ...
                dataCache.put(id, JSON.parse(data));
    ...
    service.signUp = function (data) {
        ...
        $http({
            ...
            try {
                ...
                console.error("Parsing signup/signup-internal Error: %s Response: %s", e, resp);
            }
            // console.log(parsedResp);
...
.service('myCacheFactory', function (CacheFactory) {
