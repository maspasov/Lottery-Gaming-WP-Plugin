...
class Carbon_Field
{
     ...
     * @return object $this
     **/
    public function set_datastore(Carbon_DataStore $store)
    {
        $this->store = $store;
        return $this;
    }
...
class Carbon_Field_Date extends Carbon_Field
{
    ...
    public function template()
    {
		...
		<div class="input-with-button">
			...
			<span class="carbon-datepicker-trigger button icon-button hide-if-no-js"><?php _e('Date', 'crb');
        ?></span>
		</div>
		<?php
    ...
    public function template()
    {
		...
		<div class="carbon-color-row">
			<div class="input-with-button">
				...
				<span class="pickcolor button icon-button hide-if-no-js"><?php _e('Select a Color', 'crb');
        ?></span>
			</div>
...
class Carbon_Field_Map extends Carbon_Field
{
    ...
    public function template()
    {
		...
		<div class="carbon-map-search">
			<p><?php _e('Locate Address on the map', 'crb');
        ?>: </p>
			...
			<div class="carbon-set-list">
				<# _.each(options, function(option, i) { #>
					...
					<# if (!exceed && !last && counter == limit_options) { #>
						<p>... <a href="#" class="carbon-set-showall"><?php _e('Show All Options', 'crb');
        ?></a></p>
					<# } #>
				<# }) #>
			</div>
...
class Carbon_Field_Gravity_Form extends Carbon_Field_Select
{
    ...
    public function template()
    {
        ...
        if (!$this->is_plugin_active()) {
            ?><em><?php _e('Please install Gravity Forms plugin', 'crb');
            ?></em><?php
            return;
        }
        ...
        if (empty($this->options)) {
            ?><em><?php _e('No Gravity Forms have been found.', 'crb');
            ?></em><?php
            return;
        }
