...
class Theme_Options_Container extends Container
{
    ...
    public function init()
    {
        ...
        } elseif (strpos($this->settings['parent'], '.php') === false) {
    ...
    public function is_valid_save()
    {
        if (! isset($_SERVER['REQUEST_METHOD']) || $_SERVER['REQUEST_METHOD'] != 'POST') {
            return false;
        } elseif (! isset($_REQUEST[ $this->get_nonce_name() ]) || ! wp_verify_nonce($_REQUEST[ $this->get_nonce_name() ], $this->get_nonce_name())) {
            return false;
        }
