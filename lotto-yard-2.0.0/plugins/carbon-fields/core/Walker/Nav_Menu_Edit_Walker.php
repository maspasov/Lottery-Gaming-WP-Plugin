...
class Nav_Menu_Edit_Walker extends \Walker_Nav_Menu
{
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        ?>" class="item-move-up"><abbr title="<?php esc_attr_e('Move up', 'carbon_fields');
        ?>">&#8593;</abbr></a>
							|
							<a href="<?php
                                echo wp_nonce_url(
        ...
        ?>" class="item-move-down"><abbr title="<?php esc_attr_e('Move down', 'carbon_fields');
        ?>">&#8595;</abbr></a>
						</span>
						<a class="item-edit" id="edit-<?php echo esc_attr($item_id);
        ?>" title="<?php esc_attr_e('Edit Menu Item', 'carbon_fields');
        ?>" href="<?php
                            echo (isset($_GET['edit-menu-item']) && $item_id == $_GET['edit-menu-item']) ? admin_url('nav-menus.php') : add_query_arg('edit-menu-item', $item_id, remove_query_arg($removed_args, admin_url('nav-menus.php#menu-item-settings-' . $item_id)));
        ?>"><?php _e('Edit Menu Item', 'carbon_fields');
        ?></a>
					</span>
				</div>
			</div>
        ...
        ?>">
						<?php _e('Navigation Label', 'carbon_fields');
        ?><br />
        ...
        ?>">
						<?php _e('Title Attribute', 'carbon_fields');
        ?><br />
        ...
        ?>" value="_blank" name="menu-item-target[<?php echo esc_attr($item_id);
        ...
        ?>">
						<?php _e('CSS Classes (optional)', 'carbon_fields');
        ?><br />
        ...
        ?>">
						<?php _e('Link Relationship (XFN)', 'carbon_fields');
        ?><br />
        ...
        ?>">
						<?php _e('Description', 'carbon_fields');
        ?><br />
        ...
        ?>]"><?php echo esc_html($item->description); // textarea_escaped ?></textarea>
						<span class="description"><?php _e('The description will be displayed in the menu if the current theme supports it.', 'carbon_fields');
        ?></span>
					</label>
				</p>
        ...
        ?>
				...
				<p class="field-move hide-if-no-js description description-wide">
					<label>
						<span><?php _e('Move', 'carbon_fields');
        ?></span>
						<a href="#" class="menus-move menus-move-up" data-dir="up"><?php _e('Up one', 'carbon_fields');
        ?></a>
						<a href="#" class="menus-move menus-move-down" data-dir="down"><?php _e('Down one', 'carbon_fields');
        ?></a>
						<a href="#" class="menus-move menus-move-left" data-dir="left"></a>
						<a href="#" class="menus-move menus-move-right" data-dir="right"></a>
						<a href="#" class="menus-move menus-move-top" data-dir="top"><?php _e('To the top', 'carbon_fields');
        ?></a>
					</label>
				</p>
