...
abstract class Carbon_Widget extends WP_Widget implements Carbon_DataStore
{
    ...
    /* Implement DataStore */
    public function load(Carbon_Field $field)
    {
    ...
    public function save(Carbon_Field $field)
    {
        $this->store_data[$field->get_name()] = $field->get_value();
    }
    
    public function delete(Carbon_Field $field)
    {
        if (isset($this->store_data[$field->get_name()])) {
    ...
    public function delete_values(Carbon_Field $field)
    {
        $field_name = $field->get_name();
